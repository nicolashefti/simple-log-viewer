...
.credits{border-top:1px solid #DDD; color:#CCC;font-size:10px;text-align: center;margin-top:50px}
.credits a {color:#CCC;}
  </style>
</head>
...
<div id="layout">
	...
	foreach($files as $k=>$f){
		...
		$active = ($k == $log) ? 'pure-menu-selected':'';
		echo '<li class="pure-menu-item '.$active.'"><a href="?p='.$k.'&lines='.$lines.'" class="pure-menu-link">'.$f['name'].'</a></li>';
	}
?>
    ...
    <div id="main">
        <div class="header">
            <h1><?= $title;?></h1>
            <h2  class="content-subhead">Here are the last <?= $lines ?> of your <?= $title?> <small>(<?= $file ?>)</small></h2>
...
<footer>
<p class="credits"><a href="//pixeline.be">Script provided by pixeline</a>, thanks to <a href="//purecss.io/">purecss.io</a></p>
</footer>
</div>
    </div>
</div>
